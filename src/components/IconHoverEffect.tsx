...
function IconHoverEffect({ children, red=false }: IconHoverEffectProps) {
    const colorClasses = red 
        ? "outline-red-400 hover:bg-red-200 group-hover:bg-red-200 focus-visibile:bg-red-200"
        : "outline-gray-400 hover:bg-gray-200 group-hover:bg-gray-200 focus-visibile:bg-gray-200"
